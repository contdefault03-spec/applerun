...
export const DEFAULT_BINDINGS = {
  ...
  chat: 'KeyT', map: 'KeyM', bigmap: 'KeyK', camera: 'KeyC', emote: 'KeyB', phone: 'KeyP', horn: 'KeyH',
};
export const BINDING_LABELS = {
  ...
  emote: 'Emote / special move', phone: 'Jobs & activities menu', horn: 'Horn / siren', bigmap: 'Detailed map (zoom/pan)',
};
const DEFAULTS = {
  'player.name': '',
